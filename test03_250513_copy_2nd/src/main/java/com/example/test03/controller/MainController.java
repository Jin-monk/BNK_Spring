...
public class MainController {
	...
	public String comingMovie(Model model) {
		...
		List<MovListDTO> commingMov = movListDao.getComingMovie();
		model.addAttribute("commingMov", commingMov);
		return "comingMovie";
	}
	
	@GetMapping("endMovie")
	public String endMovie(Model model) {
		System.out.println("endMovie...");
		List<MovListDTO> endMov = movListDao.getEndMovie();
